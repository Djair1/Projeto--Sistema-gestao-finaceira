...
<div onclick="aviso();" class="container-xl">
  ...
  <form id="formulario" class="form-control" action="<?php echo site_url('cadastro/Realizar_cadastro'); ?>  " method="post">
    ...
    <div class="form-group">
      <input type="E-mail"  placeholder="E-mail" class="form-control" id="exampleInputEmail1" name="text_email" aria-describedby="emailHelp" required>
    </div>

    <div class="form-group">
      <input type="Telefone"  onkeypress="$(this).mask('(00) 0000-00009')" placeholder="Telefone" class="form-control" id="exampleInputTelefone1" name="text_Telefone" required>
    </div>

    <div class="form-group">
      <input type="password"  placeholder="Senha" class="form-control" id="exampleInputPassword1" name="text_senha" required>
    </div>
    

    <div class="form-group">
      <input type="password"  placeholder="Confirmar Senha" class="form-control" id="exampleInputPassword2" name="confirm_senha" required>
    </div>
