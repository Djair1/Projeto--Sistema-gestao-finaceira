    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo site_url('Painel/alterarSenha'); ?>  " method="post">
          ...
          <br>
          <hr>
          <button style="width:470px ;height:35px ;font-size: 17px; border-radius: 16px ; background-color: #4682B4;" type="submit"  class="btn btn-primary">SALVAR</button>
        </form>
  ...
  <div class="modal-dialog" role="document" style="overflow-y: initial;">
    <div class="modal-content" style="width:1200px ;right: 350px">
      ...
      <div class="modal-body" style="height: 550px; overflow-y: auto;">
        ...
        <button type="button" class="btn btn-link" onclick="javascript:window.location.href='<?php echo site_url('GerirFinancas/gerar_pdf_renda'); ?>'" style="margin-left: 88% ; margin-bottom: 10px;">Gerar Relatório</button>
        <br>
...
<td><?= $row['descricao_despesa_fixa_mensal']; ?></td>

<td style="background-color:#DCDCDC"><center><?= number_format( $row['despesa_fixa_mensal'], 2, ',', '.');?> R$</center></td>

<td><?= $row['descricao_despesa_variavel_mensal_1']; ?></td>

<td style="background-color:#DCDCDC"><center><?=number_format($row['despesa_variavel_mensal'], 2, ',', '.');?> R$</center></td>

<td><?= $row['descricao_despesa_variavel_mensal_2']; ?></td>

<td style="background-color:#DCDCDC"><center><?=number_format( $row['despesa_variavel_mensal_2'], 2, ',', '.');?> R$</center></td>

<td><?= $row['descricao_despesa_variavel_mensal_3']; ?></td>

<td style="background-color:#DCDCDC"><center><?=number_format($row['despesa_variavel_mensal_3'], 2, ',', '.') ;?> R$</center></td>

<td><?= $row['descricao_despesa_variavel_mensal_4']; ?></td>

<td style="background-color:#DCDCDC"><center><?=number_format($row['despesa_variavel_mensal_4'], 2, ',', '.') ;?> R$</center></td>

<td><?= $row['descricao_despesa_variavel_mensal_5']; ?></td>

<td style="background-color:#DCDCDC"><center><?=number_format($row['despesa_variavel_mensal_5'], 2, ',', '.') ;?> R$</center></td>
