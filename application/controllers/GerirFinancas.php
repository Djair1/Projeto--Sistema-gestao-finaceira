...
$pdf->cell(20,5,utf8_decode($row['data']),1,0,"c",1);
$pdf->Cell(85,5,utf8_decode($row['descricao_renda_fixa_mensal']) , 1 , "L" , false,1);
$pdf->Cell(45,5,utf8_decode($row['renda_fixa_mensal']) , 1 , "L" , false,1);
$pdf->cell(85,5,utf8_decode($row['descricao_renda_variavel_mensal_1']) , 1 , "L" , false,1);
$pdf->cell(45,5,utf8_decode($row['renda_variavel_mensal']) , 1 , "L" , false,1);
$pdf->Ln();
...
$pdf->cell(20,5,utf8_decode($row['data']),1,0,"c");
$pdf->Cell(85,5,utf8_decode($row['descricao_renda_variavel_mensal_2']) , 1 , "L" , false);
$pdf->Cell(45,5,utf8_decode($row['renda_variavel_mensal_2']) , 1 , "L" , false);
$pdf->cell(85,5,utf8_decode($row['descricao_renda_variavel_mensal_3']) , 1 , "L" , false);
$pdf->cell(45,5,utf8_decode($row['renda_variavel_mensal_3']) , 1 , "L" , false);
$pdf->Ln();
...
$pdf->cell(20,5,utf8_decode($row['data']),1,0,"c");
$pdf->Cell(85,5,utf8_decode($row['descricao_renda_variavel_mensal_4']) , 1 , "L" , false);
$pdf->Cell(45,5,utf8_decode($row['renda_variavel_mensal_4']) , 1 , "L" , false);
$pdf->cell(85,5,utf8_decode($row['descricao_renda_variavel_mensal_5']) , 1 , "L" , false);
$pdf->cell(45,5,utf8_decode($row['renda_variavel_mensal_5']) , 1 , "L" , false);
$pdf->Ln();
...
$pdf->cell(20,5,utf8_decode($row['data']),1,0,"c");
$pdf->cell(85,5,utf8_decode(number_format($row['saldo'])) , 1 , "L" , false);
$pdf->Ln();
